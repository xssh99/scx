...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Premium Sript ${YELLOW}(${NC}${green} Julak Bantur ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} Julak ${NC}${YELLOW}(${NC} ${green} Bantur${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/xssh99/scx/main/"
...
function print_success() {
    if [[ 0 -eq $? ]]; then
		echo -e "${green} =============================== ${FONT}"
        echo -e "${Green} # $1 Success Install"
		echo -e "${green} =============================== ${FONT}"
        sleep 2
    fi
}
...
function base_package() {
    clear
    ########
    print_install "Menginstall Service Packet"
...
function pasang_ssl() {
clear
print_install "Menginstall SSL Certificate"
...
clear
    print_install "Menginstall Core Xray Latest Version"
    # install xray
...
EOF
print_success "Konfigurasi Service"
}
...
function udp_mini(){
clear
print_install "Menginstall Service Limit User"
wget https://raw.githubusercontent.com/xssh99/scx/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
wget -q -O /usr/local/kyt/udp-mini "${REPO}waluh/udp-mini"
chmod +x /usr/local/kyt/udp-mini
wget -q -O /etc/systemd/system/udp-mini-1.service "${REPO}waluh/udp-mini-1.service"
wget -q -O /etc/systemd/system/udp-mini-2.service "${REPO}waluh/udp-mini-2.service"
wget -q -O /etc/systemd/system/udp-mini-3.service "${REPO}waluh/udp-mini-3.service"
...
print_success "Limit User Service"
}

function ssh_slow(){
clear
# // Installing UDP Mini
print_install "Menginstall SlowDNS"
...
function ins_SSHD(){
clear
print_install "Menginstall SSHD Config"
