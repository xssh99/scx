...
REVISI="https://raw.githubusercontent.com/xssh99/scx/main/rabah/"
...
#echo -e "        ${z}❒════════════════════════════════════════════❒${NC}" 
#echo -e "                ${KIRI}${z}Julak  Bantur${z}${KANAN}"
...
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC   [${green}01${NC}] SSH              [${green}07${NC}] CHECK BANDWITH    ${z}  │$NC" 
echo -e " ${z}│$NC   [${green}02${NC}] VMESS             [${green}08${NC}] SPEEDTEST     ${z}  │$NC"    
echo -e " ${z}│$NC   [${green}03${NC}] VLESS            [${green}09${NC}] LIMIT SPEED    ${z}  │$NC"  
...
12)
clear
rm -rf update.sh && wget ${REVISI}update.sh && chmod +x update.sh && ./update.sh
;;
*)
clear
menu
